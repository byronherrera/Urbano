	...
	initialize: function(menu, options){
     ...
     addnavbtn: function(){
        ...
        if (!(Browser.ie && Browser.version < 9)) {
            ...
            if(jlevel0){
                var jmega = this.menu,
                    jbutton = new Element ('div', {id:'js-megamenu-button', 'class':'js-megamenu-button', html: 'Navigation', styles: { display: 'none'}}).inject (jmega, 'before');
...
//                    li.eff_off.to.push (0);
            ...
            if (this.options.action == 'mouseenter' && li.childcontent) {
                ...
                jbutton1 = new Element ('span', {class:'mega', html: 'Navigation', styles: { display: 'none'}}).inject (li.childcontent, 'before');
                jbutton1.addEvent('click', function(e) {
                    var event = new DOMEvent (e);
                    //if (li.hasClass ('group')) return;
