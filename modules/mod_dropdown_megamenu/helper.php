...
class Mod_DropDown_MegaMenu {
	...
	function endMenu($startlevel=0, $endlevel = 10){
		...
		$hozorver	= $this->_params->get('hozorver', 'horizontal');
        
		if($hozorver == 'horizontal') {
			$direction	= $this->_params->get('horizontal_submenu_direction', 'down');
		} else {
			$direction	= $this->_params->get('vertical_submenu_direction', 'lefttoright');
		}
