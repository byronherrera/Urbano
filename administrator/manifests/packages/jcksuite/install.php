...
class pkg_jcksuiteInstallerScript
{
	...
	function 	preflight( $type, $parent ) 
	{
		...
		{
			Jerror::raiseWarning(null, 'Cannot install this version of the JCK Suite package in a Joomla 3.0 release. This package is compatible with Joomla '.$this->maxiuim_joomla_release .' only.');
			return false;
		}
	}
