...
?>
	<tr class="<?php echo "row$k"; ?>">
		...
		<td>
			...
			<?php } ?>
			<?php if(strtolower($row->name) == strtolower($this->default)) : ?>
				<span> - Administrator</span>
			<?php elseif(strtolower($row->name) == strtolower($this->defaultFT)) : ?>
				<span> - Site</span>
			<?php endif; ?>
		</td>
		<td align="center">
			<?php if(strtolower($row->name) == strtolower($this->default) || strtolower($row->name) == strtolower($this->defaultFT)) : ?>
				<a title="Default" class="jgrid"><span class="state default"><span class="text">Default</span></span></a>
			<?php else : ?>
				<a title="Set default"  class="jgrid"><span class="state notdefault"></span></a>
			<?php endif; ?>	
		</td>
		<td nowrap="nowrap">
			<?php echo $row->name;?>
